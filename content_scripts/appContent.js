...
chrome.runtime.onMessage.addListener(function(request, sender, sendResponse) {
  ...
  if (request.openApp) {
    createIframe();
    sendResponse({ success: true, message: "opened" });
  }
  return true;
});

function createIframe() {
  loadHtm(function(html) {
    let app = document.querySelector("#clipBoardAndNotesExtension");
    if (app) {
      return app.classList.add("visible");
    }
    var appBody = document.createElement("section");
    appBody.classList.add("appBody");
    appBody.id = "clipBoardAndNotesExtension";
    var mainContent = document.createElement("section");
    mainContent.classList.add("inputArea");
...
function loadHtm(func) {
  ...
  xhttp.open(
    "GET",
    chrome.extension.getURL("content_scripts/appContent.htm"),
    true
  );
  xhttp.send();
}
    ...
    if (e.ctrlKey && e.keyCode == 86) {
      ...
      getNotesAnd(notes => {
        ...
        chrome.storage.sync.set(
          {
            notes: (Array.isArray(notes) ? notes : []).concat([
              { text, noteId }
            ])
          },
          () => {
...
" />`;
  ...
  function formatDate(date) {
    ...
    return `${
      days[date.getDay()]
    } ${date.getDate()}-${doubleDigits(date.getMonth() + 1)}-${date.getFullYear()} ${doubleDigits(date.getHours())}:${doubleDigits(date.getMinutes())}:${doubleDigits(date.getSeconds())}`;
  }
